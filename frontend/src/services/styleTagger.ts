...
export const CATEGORIES: Record<string, CategoryDef> = {
  ...
  jeans_dunkel:       { parent:'bottoms', display:'Jeans (dunkel, slim)',      style_tags:['classic','casual','smart_casual'],                      seasons:['spring','summer','autumn','winter'], formality:2, description:'Dunkle Waschung — Ivy-League-Klassiker: Blazer + dunkle Jeans + Brogue' },
